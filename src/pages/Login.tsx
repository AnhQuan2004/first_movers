...
// Using the public logo instead of the assets one
...
const Login = () => {
    ...
    async (emailAddress: string) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          // User will be redirected to the main page and can edit their profile later.
      ...
      // Redirect to the main page instead of the profile setup page.
      navigate("/", { replace: true });
    },
    [navigate],
  );
  ...
  return (
    <main className="relative min-h-screen bg-[url('/background.png')] bg-cover bg-center bg-no-repeat text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-10 px-6 py-12 sm:px-10">
        <header className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo.png" alt="First Mover" className="h-12 w-auto" />
